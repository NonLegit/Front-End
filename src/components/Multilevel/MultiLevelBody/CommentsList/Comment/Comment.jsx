            ...
            : (
              <>
                ...
                {replies?.map((reply, i) => {
                  ...
                  return (<Comment key={reply?._id} comment={reply} src="https://styles.redditmedia.com/t5_74w4tr/styles/profileIcon_9or0sb8dtc5a1.jpeg?width=256&height=256&crop=256:256,smart&s=2a8b7dc794b00e51a6b9f423da2204a999136ecb" depth={depth + 1} level={i} lastChild={i === replies.length - 2} remainingSiblings={replies[replies.length - 1]?.count} loadMoreComments={loadMoreComments} />);
                })}
