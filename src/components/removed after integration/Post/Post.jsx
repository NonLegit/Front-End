...
// mui components
import {
  Avatar, Box, Divider, IconButton, ListItemButton, ListItemIcon,
...
// styles
import {
  PostContainer, Popularity, PostInfo, PostInfoLink, PostTitle,
  PostMedia, PostActions, ActionButton, ShowMoreList, ShowMoreListItemText,
} from './styles';
      ...
      <Box width="100%" p={1}>
        ...
        <PostTitle to="/">
          <Typography variant="h6" component="h3" sx={{ fontSize: 18 }}>
            In 1991 Michael Jordan shot a free
            throw with his eyes closed while playing the Denver Nuggets.
            {' '}
            <RedditButton
              fontSize={10}
              padding="2px 10px"
        ...
        <PostMedia pt={1.5}>
          ...
          <video controls>
            <source src="public\[EgyBest].Breaking.Bad.S01E02.BluRay.360p.x264.mp4" type="video/mp4" />
          </video>
