  ...
  useEffect(() => {
    ...
    axios.get(url, {
      ...
      setData((data) => {
        ...
        tempData.savedPosts = [...tempData.savedPosts, ...response.data.savedPosts];
        tempData.savedComments = [...tempData.savedComments, ...response.data.savedComments];
        return tempData;
      });
